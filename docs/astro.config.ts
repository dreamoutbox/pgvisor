...
const repo = process.env.GITHUB_REPOSITORY
  ...
  : undefined;
const base = process.env.BASE_PATH || (repo ? `/${repo}` : undefined);

const nimbusConfig = defineNimbusConfig({
  site: process.env.SITE_URL || "https://dreamoutbox.github.io",
  title: "PgVisor Documentation",
  description:
    "Lightweight, pure-Rust PostgreSQL High Availability cluster supervisor, L7 proxy, and continuous backup pipeline.",
  locale: "en",
  github: "https://github.com/dreamoutbox/pgvisor",
  socialImageAlt: "PgVisor documentation preview",
});
